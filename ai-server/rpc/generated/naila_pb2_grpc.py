...
from rpc.generated import naila_pb2 as naila__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in naila_pb2_grpc.py depends on'
...
def add_NailaAIServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'naila.NailaAI', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('naila.NailaAI', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class NailaAI(object):
    """=============================================================================
    Service
    =============================================================================
